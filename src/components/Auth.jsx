  ...
  return (
    <div className="card">
      ...
      <form onSubmit={submit} className="row">
        {mode==='register'&&<div className="col"><label>Имя</label><input value={name} onChange={e=>setName(e.target.value)} placeholder="Например, Inga"/></div>}
        {mode==='register'&&<div className="col"><label>Instagram</label><input value={instagram} onChange={e=>setInstagram(e.target.value)} placeholder="@username"/></div>}
        {mode==='register'&&<div className="col"><label>Email (опционально)</label><input value={email} onChange={e=>setEmail(e.target.value)} placeholder="name@example.com"/></div>}
        {mode==='register'
